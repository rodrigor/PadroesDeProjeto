 ...
 *
 */
public class Celular implements EstacaoListener {

	/* (non-Javadoc)
	 * @see com.rodrigor.padroes.observer.estacao.EstacaoListener#novaTemperatura(com.rodrigor.padroes.observer.estacao.EstacaoEvent)
	 */
	public void novaTemperatura(EstacaoEvent event) {
		System.out.println("Temperatura: "+event.getTemperatura()+" graus celsius");
