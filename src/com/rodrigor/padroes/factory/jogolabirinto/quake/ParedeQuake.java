...
import com.rodrigor.padroes.factory.jogolabirinto.Porta;

public class ParedeQuake implements Parede {

	private PortaQuake porta = null;
	
	
	public void setPorta(Porta porta) {
		this.porta = (PortaQuake)porta;
