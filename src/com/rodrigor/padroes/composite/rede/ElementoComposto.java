 ...
 *
 */
public class ElementoComposto extends ElementoDeRede {
	
	protected List<ElementoDeRede> elementos;
	
	public ElementoComposto(){
		elementos = new LinkedList<ElementoDeRede>();
	}
	
	public void addElemento(ElementoDeRede elemento){
		elemento.setPai(this);
		this.elementos.add(elemento);		
	}
	
	public void desenhar(Painel painel){
		for(ElementoDeRede elemento: elementos){
			elemento.desenhar(painel);
		}
	}
